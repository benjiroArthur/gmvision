...
$(function () {
  // Get the form.
  var form = $('#ajax_form'); // Get the messages div.
  ...
  $(form).submit(function (event) {
    ...
    $.ajax({
      ...
      $(formMessages).addClass('alert-success'); // Set the message text.
      ...
      $(formMessages).addClass('alert-danger'); // Set the message text.
